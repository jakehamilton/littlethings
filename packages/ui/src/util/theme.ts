...
const DEFAULT_SHADOWS = {
	xs: "0 1.1px 1.4px -49px rgba(0, 0, 0, 0.014), 0 2.5px 3.4px -49px rgba(0, 0, 0, 0.02), 0 4.8px 6.4px -49px rgba(0, 0, 0, 0.025), 0 8.5px 11.4px -49px rgba(0, 0, 0, 0.03), 0 15.9px 21.3px -49px rgba(0, 0, 0, 0.036), 0 38px 51px -49px rgba(0, 0, 0, 0.05)",
	sm: "0 1.1px 1.4px -13px rgba(0, 0, 0, 0.014), 0 2.5px 3.4px -13px rgba(0, 0, 0, 0.02), 0 4.8px 6.4px -13px rgba(0, 0, 0, 0.025), 0 8.5px 11.4px -13px rgba(0, 0, 0, 0.03), 0 15.9px 21.3px -13px rgba(0, 0, 0, 0.036), 0 38px 51px -13px rgba(0, 0, 0, 0.05)",
	md: "0 0.7px 1.1px rgba(0, 0, 0, 0.022), 0 1.6px 2.6px rgba(0, 0, 0, 0.032), 0 3px 4.9px rgba(0, 0, 0, 0.04), 0 5.4px 8.7px rgba(0, 0, 0, 0.048), 0 10px 16.3px rgba(0, 0, 0, 0.058), 0 24px 39px rgba(0, 0, 0, 0.08)",
	lg: "0 0.7px 4.5px rgba(0, 0, 0, 0.031), 0 1.6px 10.7px rgba(0, 0, 0, 0.044), 0 3px 20.2px rgba(0, 0, 0, 0.055), 0 5.4px 36px rgba(0, 0, 0, 0.066), 0 10px 67.3px rgba(0, 0, 0, 0.079), 0 24px 161px rgba(0, 0, 0, 0.11)",
	xl: "0 0.7px 10.4px rgba(0, 0, 0, 0.051), 0 1.6px 24.9px rgba(0, 0, 0, 0.073), 0 3px 47px rgba(0, 0, 0, 0.09), 0 5.4px 83.8px rgba(0, 0, 0, 0.107), 0 10px 156.7px rgba(0, 0, 0, 0.129), 0 24px 375px rgba(0, 0, 0, 0.18)",
};
